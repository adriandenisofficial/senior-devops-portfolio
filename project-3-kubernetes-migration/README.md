...
Secret Creation: Encrypts credentials.

Database Initialization: postgres-0 mounts the volume and initializes the schema.

Dashboard Launch: pgadmin starts and awaits database readiness.
